...
<html>
	...
	<body>
		<?php
			SESSION_START();
			if(!isset($_SESSION['usuario'])&&!isset($_SESSION['contra'])&&isset($_POST['usui'])&&isset($_POST['coni']))
			{
				...
				if(isset($_SESSION['numeroe']))
				{
					...
					<ol>
						<li><a href="./visa1.php">Práctica: validación de VISA</a></li>
						<li><a href="./curp1.php">Práctica: validación de CURP</a></li>
						<li><a href="./saludo.php">Práctica 1: saludo en github</a></li>
						<li><a href="./seg11.php">Práctica 2</a></li>
						<li><a href="./seg21.php">Práctica 3</a></li>
						<li><a href="./seg31.php">Práctica 4</a></li>
						<li><a href="./seg41.php">Práctica 5</a></li>
						<li><a href="./seg51.php">Práctica 6</a></li>
						<li><a href="./seg71.php">Práctica 7</a></li>
						<li><a href="./seg81.php">Práctica 8</a></li>
						<li><a href="./seg91.php">Práctica 9</a></li>
					</ol>
